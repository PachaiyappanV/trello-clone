...
const MarketingPage = () => {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      >
        <div className="flex items-center border rounded-full bg-amber-100 text-amber-700 uppercase p-4 mb-4">
        ...
        <div className="text-white text-3xl md:text-6xl bg-gradient-to-r from-fuchsia-600 to-pink-600 rounded-md px-4 p-2 mb-4">
          work forward.
        </div>
      </div>
      <div
